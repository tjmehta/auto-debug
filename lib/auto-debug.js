...
AutoDebug.prototype.trace = function (calleeArgs) {
  ...
  if (opts.args) {
    str += ' %o';
    args.push(this.calleeArgsAsObj(callee, calleeArgs));
  }
  if (opts.caller) {
    str += ' %s';
...
AutoDebug.prototype.calleeArgsAsObj = function (callee, calleeArgs) {
  var fn = callee.getFunction();
  var args = Array.prototype.slice.call(calleeArgs || fn.arguments);
